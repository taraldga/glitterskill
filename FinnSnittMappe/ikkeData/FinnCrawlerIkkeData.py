...
def fetch_ad_urls():
    result = json.loads(urllib2.urlopen("http://m.finn.no/job/fulltime/search.json?occupation=0.6&occupation=0.16&occupation=0.19&occupation=0.26&occupation=0.28&occupation=0.32&occupation=0.48&occupation=0.51&occupation=0.53&occupation=0.59&occupation=0.64&occupation=0.68&occupation=0.9999").read().decode("utf-8"))
